...
$title = "Selection Ver. 4 Solution";
...
body { text-align: justify; font-family: Arial, Verdana, Helvetica, sans-serif; font-size:12px; color: #000; margin:0px; min-width: 900px; background: #fff; }
...
$content = "<b>There is a hidden string (39 chars) in this mess:</b><br/><b class=\"small\">Added: Nov 9, 2009 / FF, Chrome &amp; Safari Only / View source for the hint ...</b><br/><br/><div id=\"seldiv\"><!--- /* Hint: First char is a 't' and the whole hidden string is to be read vertically */ --->";
